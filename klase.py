...
class NRoot(Function):
    def __init__(self, nroot, function):
    ...
    def getValue(self, x):
        ...
        if self.nroot == 0:
            return "Undefined"
        return self.function.getValue(x) ** (1/self.nroot)

    def ViewF(self):
        return "the " + str(self.nroot) + " root of " + self.function.ViewF()
